...
const QRScanner = ({ onScanSuccess, onScanError }) => {
    ...
    // Affiché à la place du flux vidéo si la caméra est inaccessible
    // (permission refusée, déjà utilisée par une autre app...) - sans ça
    // l'utilisateur voit juste un cadre vide/figé sans comprendre pourquoi.
            ...
            <div className="w-full max-w-sm rounded-2xl overflow-hidden border-2 border-slate-200 shadow-inner bg-slate-900 aspect-square flex items-center justify-center relative">
                {cameraError ? (
                    <div className="flex flex-col items-center gap-3 p-6 text-center">
                        <CameraOff className="text-slate-400" size={40} strokeWidth={1.5} />
