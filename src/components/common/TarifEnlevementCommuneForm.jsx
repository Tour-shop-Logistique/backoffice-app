...
const TarifEnlevementCommuneForm = ({ id = "enlevement-commune-form", onSubmit, initialData, communes = [] }) => {
  ...
  return (
    <form id={id} onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <label className={labelClasses}>Montant d'enlèvement à domicile (FCFA)</label>
        <input
          type="number"
...
export default TarifEnlevementCommuneForm;
